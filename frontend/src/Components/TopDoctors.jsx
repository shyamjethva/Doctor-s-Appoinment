        ...
        <div className='flex flex-col items-center gap-4 my-16 text-grey-900 md:mx-10'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 px-2 py-6'>
                {doctors.slice(0, 10).map((item, index) => (
                    <div className='border border-blue-200 rounded-xl overflow-hidden cursor-pointer hover:translate-y-[-10px] transition-all duration-500' onClick={() => { navigate(`/appointment/${item._id}`); scrollTo(0, 0) }} key={index}>
